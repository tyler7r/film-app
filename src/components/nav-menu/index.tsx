        ...
        <div class={styles['overlay']}>
            <div class={styles['menu-container']}>
                ...
                <div class={styles["btn-container"]}>
                    <a href='/film-room' class={styles['menu-btn']}>Film Room</a>
                    <a href='/inbox' class={styles['menu-btn']}>Inbox</a>
                    <a href={`/profile/${teamId}`} class={styles['menu-btn']}>Team Profile</a>
                    <a href='/login' class={styles['menu-btn']}>Login</a>
                </div>
            </div>
        </div>
    )
