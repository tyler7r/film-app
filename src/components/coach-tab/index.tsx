        ...
        <ContentCard>
            ...
            <div q:slot='content'>
                <div class={styles["btn-container"]}>
                    <ContentLink class={styles['coach-btn']} id={styles['announcement-btn']} onClick$={() => teamAnnouncementOpen.value = true}>Send Team Announcement</ContentLink>
                    <ContentLink class={styles['coach-btn']} onClick$={() => setScoutingOpen.value = true}>Set Scouting Tab</ContentLink>
                    <ContentLink class={styles['coach-btn']} onClick$={() => editRosterOpen.value = true}>Edit Roster</ContentLink>
                </div>
